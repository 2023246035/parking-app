                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.textarea(
                            ...
                            value=BookingState.user_cancellation_reason,
                            on_change=BookingState.set_user_cancellation_reason,
                            rows="3",
                            class_name="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-sm"
                        ),
                        rx.el.p(
